   ...
   <body>
     ...
     <div class="container">
      <!-- <img src=image/bus.png alt="" class="image-resize" style="width: 100%; height: 550px;"> -->
     </div>
          ...
          ?>
               ...
               <div class="col-lg-3 col-md-3 col-sm-6">
                 <div class="running-movie">
                   ...
                   <h5><b><?php echo $row['buses_name']; ?></b></h5>
                   <h6>
                     <center><?php echo $row['language']; ?></center>
                   </h6>
                   <a href="bus_details.php?pass=<?php echo $row['id']; ?>" class="btn btn-primary">Book Now</a>
                 </div>
               </div>
