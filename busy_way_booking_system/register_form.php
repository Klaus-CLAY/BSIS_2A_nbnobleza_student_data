...
<body>
  ...
  <div class="container">
    <center><a href="./index.html"><img src="img/busy-way-3.png" alt="" style="margin-top: 80px; width: 50%;"></a></center>
...
{
   error = " <font color='red'>!please not allow 2 and 20 character/font> ";
