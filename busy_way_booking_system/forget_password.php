			...
			<td align="center" valign="middle">
				<div class="loginholder">
					...
					<tr>
  						...
  						<a href="./index.html"><img src="img/busy-way-3.png" alt="" width="250px"></a>
					</tr>
					<tr>
						<td><b>Email:</b></td>
					</tr>
...
<script type="text/javascript">
  ...
  $("#login").click(function(){
    ...
    var cpassword = $("#cpassword").val().trim();
     ...
     if( email == "" )
 {
  error = " <font color='red'>!Name Requried.</font> ";
  ...
  if( oldpassword == "")
 {
  error = " <font color='red'>!Email Requried.</font> ";
 ...
 {
  error = " <font color='red'>!Password does not Match.</font> ";
  document.getElementById( "cpassworderror" ).innerHTML = error;
  return false;
 }
    $.ajax({
