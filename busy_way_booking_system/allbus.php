        ...
        <div class="row">
            ...
            <div class="col-md-3">                				
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(categroy) FROM add_bus WHERE status = '1' ORDER BY categroy DESC
                    ";
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(language) FROM add_bus WHERE status = '1' ORDER BY language DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
