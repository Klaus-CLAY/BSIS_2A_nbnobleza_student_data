                    ...
                    <div class="tab-content">
                        <div class="row">
                                ...
                                if(isset($_POST['submit'])){
                                    $show = $_POST['show'];
                                $result = mysqli_query($conn,"SELECT u.username,u.email,u.mobile,u.city,t.theater FROM user u INNER JOIN time_schedule t on u.username = '".$username."' WHERE t.show = '".$show."'");
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="seatCharts-container">
                                             ...
                                             <div class="front">
                                                ...
                                                <font text-align="right">Peso.<?php echo $price;?>/-</font>
                                            </div>
                                </div>
                            </div>
                                <div id="msg"></div>
