...
<head>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-2">
          <button data-toggle="modal" data-target="#add_custemer_modal" class="btn btn-primary btn-sm">ADD CUSTOMERS</button>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <select class="form-control category_list" name="username_id">
                  <option value="">CHOOSE USERNAME ID</option>
                  <?php
              ...
              <div class="col-12">
                <div class="form-group">
                  <label>BUS</label>
                  <select class="form-control category_list" name="bus">
                    ...
                    ?>
                          <option value="<?php echo $row['buses_name']; ?>"><?php echo $row['buses_name']; ?></option>
                    <?php
                        }
                      }
                    }
  ...
  <script>
    function validateform() {
      ...
      var bus = document.myform.bus.value;
